...
export function App(): ReactElement {
  ...
  const selectedTodo =
    state.todos.find((todo) => todo.id === selectedId) ?? null;
  ...
  const setStateField = <K extends keyof AppState>(
    key: K,
    value: AppState[K],
  ): void => {
        ...
        <aside className="task-composer" aria-label="Create todo">
          <form onSubmit={createTask}>
            ...
            <button
              ...
              type="submit"
              disabled={!isLoaded || draft.title.trim().length === 0}
            >
              <Plus size={18} />
              Add task
            </button>
          ...
          <div className="toolbar">
            <label className="search-box">
              ...
              <input
                ...
                onChange={(event) =>
                  setStateField("searchQuery", event.target.value)
                }
            ...
            <select
              ...
              onChange={(event) =>
                setStateField(
                  "statusFilter",
                  event.target.value as AppState["statusFilter"],
                )
              }
            ...
            <select
              ...
              onChange={(event) =>
                setStateField(
                  "priorityFilter",
                  event.target.value as AppState["priorityFilter"],
                )
              }
            ...
            <select
              ...
              onChange={(event) =>
                setStateField(
                  "sortBy",
                  event.target.value as AppState["sortBy"],
                )
              }
            ...
            <>
              ...
              <label>
                ...
                <textarea
                  ...
                  onChange={(event) =>
                    patchTodo(selectedTodo.id, (todo) =>
                      updateTodo(todo, {description: event.target.value}),
                    )
                  }
                />
              </label>
              ...
              <label>
                ...
                <input
                  ...
                  onChange={(event) =>
                    patchTodo(selectedTodo.id, (todo) =>
                      updateTodo(todo, {tags: parseTags(event.target.value)}),
                    )
                  }
                />
              </label>
            ...
            <div className="kanban-stack">
              {columnTodos.length === 0 ? (
                ...
                columnTodos.map((todo) => (
                  <TodoCard key={todo.id} todo={todo} {...cardProps} />
                ))
              )}
            </div>
          </section>
